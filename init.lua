...
--     s = UI.获取按钮选择状态(b)
--     if(s)then
--         ZHITU_print("23424234")
--        -- a,path = getGitHub("https://github.com/zifanzilog/ZHITU/archive/main.zip")
--        -- UI.设置按钮图片(b,path.."/ZHITU-main/checked.png")
--        --UI.设置按钮标题颜色(按钮,0,0,255,1)
--        UI.删除按钮(28888)
--     else
--         UI.设置按钮标题颜色(按钮,0,0,0,1)
--          ZHITU_print("aa")
--     end
-- end
...
--全局视图=UI.获取全局视图()
-- 滑动视图=UI.创建滑动视图(全局视图)
-- UI.设置滑动视图窗口尺寸(滑动视图,0,0,200,200)
-- UI.设置滑动视图内容尺寸(滑动视图,500,500)
-- UI.设置滑动视图背景颜色(滑动视图,0,255,0,1)


-- 普通视图 = UI.创建普通视图(滑动视图)   --控件页面
-- UI.设置普通视图窗口尺寸(普通视图,20,20,200,200)
-- UI.设置普通视图背景颜色(普通视图,0,0,0,1)

-- 按钮 = UI.创建按钮(普通视图)
-- UI.设置按钮ID(按钮,28888)
-- --UI.设置按钮窗口尺寸(按钮,0,0,100,30)
-- UI.设置普通视图窗口尺寸(按钮,20,0,100,30)
-- UI.设置按钮标题(按钮,"哦好")
-- UI.设置按钮已选择标题(按钮,"hello22222")
-- UI.设置按钮标题颜色(按钮,0,0,255,1)
-- UI.设置按钮已选择标题颜色(按钮,255,0,0,1)
-- UI.设置按钮点击事件(按钮,"点击运行函数")
-- UI.设置按钮选择状态(按钮,true)
-- --UI.设置按钮图片(按钮,"unchecked.png")
-- --UI.设置按钮已选择图片(按钮,"checked.png")




-- n = UI.获取按钮ID(按钮)
-- x,y,w,h = UI.获取按钮窗口尺寸(按钮)
-- b = UI.获取按钮选择状态(按钮)
